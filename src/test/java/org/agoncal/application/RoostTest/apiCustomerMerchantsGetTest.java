...
public class apiCustomerMerchantsGetTest {
    ...
    public void setUp() {
      ...
      String[] envVarsList = {""};
      envList = dataloader.load("src/test/java/org/agoncal/application/RoostTest/api_customer_merchantsGetTest.csv", envVarsList);
    }

  
    @Test  
    public void apiCustomerMerchantsGet_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              ...
              System.out.printf("Test Case %d: apiCustomerMerchantsGet_Test \n", testNumber++);
              System.out.println("Request: GET /api/customer/merchants");
