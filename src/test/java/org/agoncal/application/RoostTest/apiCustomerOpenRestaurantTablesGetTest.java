...
public class apiCustomerOpenRestaurantTablesGetTest {
    ...
    public void setUp() {
      ...
      String[] envVarsList = {""};
      envList = dataloader.load("src/test/java/org/agoncal/application/RoostTest/api_customer_openRestaurantTablesGetTest.csv", envVarsList);
    }

  
    @Test  
    public void apiCustomerOpenRestaurantTablesGet_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              requestBodyObject = new JSONObject(testData.get("RequestBody"));
				...
				.queryParam("RestaurantTableGroupId", testData.get("RestaurantTableGroupId") != null ? testData.get("RestaurantTableGroupId") : "")
				.queryParam("pointOfSaleId", testData.get("pointOfSaleId") != null ? testData.get("pointOfSaleId") : "")
                .when()
              ...
              System.out.printf("Test Case %d: apiCustomerOpenRestaurantTablesGet_Test \n", testNumber++);
              System.out.println("Request: GET /api/customer/openRestaurantTables");
      ...
      switch(Integer.toString(responseObj.statusCode()).charAt(0)){
          ...
          JSONArray respoJsonArray = new JSONArray(responseObj.asString()); 
            ...
            for (int it = 0; it < respoJsonArray.length(); it++) {  
              ...
              if (response.get("restaurant_table_id") != null) {
                  
                MatcherAssert.assertThat(response.get("restaurant_table_id"), instanceOf(Integer.class));
              }
