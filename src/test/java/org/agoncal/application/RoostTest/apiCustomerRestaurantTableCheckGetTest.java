...
public class apiCustomerRestaurantTableCheckGetTest {
    ...
    public void setUp() {
      ...
      String[] envVarsList = {""};
      envList = dataloader.load("src/test/java/org/agoncal/application/RoostTest/api_customer_restaurantTable_checkGetTest.csv", envVarsList);
    }

  
    @Test  
    public void apiCustomerRestaurantTableCheckGet_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              ...
              System.out.printf("Test Case %d: apiCustomerRestaurantTableCheckGet_Test \n", testNumber++);
              System.out.println("Request: GET /api/customer/restaurantTable/check");
      ...
      switch(Integer.toString(responseObj.statusCode()).charAt(0)){
              ...
              if (contentType.contains("application/xml") || contentType.contains("text/xml")) {
                ...
                if(stringifiedStatusCode.equals("200")){					System.out.println("Description: Create new Restaurant Table");
				}
