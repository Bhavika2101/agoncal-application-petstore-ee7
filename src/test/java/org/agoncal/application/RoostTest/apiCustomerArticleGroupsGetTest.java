...
public class apiCustomerArticleGroupsGetTest {
    ...
    public void setUp() {
      ...
      String[] envVarsList = {""};
      envList = dataloader.load("src/test/java/org/agoncal/application/RoostTest/api_customer_articleGroupsGetTest.csv", envVarsList);
    }

  
    @Test  
    public void apiCustomerArticleGroupsGet_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              ...
              System.out.printf("Test Case %d: apiCustomerArticleGroupsGet_Test \n", testNumber++);
              System.out.println("Request: GET /api/customer/articleGroups");
      ...
      switch(Integer.toString(responseObj.statusCode()).charAt(0)){
              ...
              if (contentType.contains("application/xml") || contentType.contains("text/xml")) {
                ...
                if(stringifiedStatusCode.equals("200")){					System.out.println("Description: Get Customer Article Groups");
				}
