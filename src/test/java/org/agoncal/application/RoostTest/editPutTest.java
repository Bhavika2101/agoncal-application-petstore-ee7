    ...
    public void editPut_Test() {
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = "https://virtserver.swaggerhub.com/VOK/Payfix/1.2.14";  
				...
				.pathParam("tableGroupId", testData.get("tableGroupId") != null ? testData.get("tableGroupId") : "")
				.pathParam("merchantId", testData.get("merchantId") != null ? testData.get("merchantId") : "")
              ...
              if (response.jsonPath().get("merchant_id") != null) {  
                MatcherAssert.assertThat(response.jsonPath().get("merchant_id"), instanceOf(Integer.class));  
          }
