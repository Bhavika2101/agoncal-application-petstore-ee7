...
public class apiPaymentSolutionTransactionsGetTest {
    ...
    public void setUp() {
      ...
      String[] envVarsList = {""};
      envList = dataloader.load("src/test/java/org/agoncal/application/RoostTest/api_paymentSolution_transactionsGetTest.csv", envVarsList);
    }

  
    @Test  
    public void apiPaymentSolutionTransactionsGet_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              requestBodyObject = new JSONObject(testData.get("RequestBody"));
				...
				.queryParam("from (hours in the past)", testData.get("from (hours in the past)") != null ? testData.get("from (hours in the past)") : "")
              ...
              System.out.printf("Test Case %d: apiPaymentSolutionTransactionsGet_Test \n", testNumber++);
              System.out.println("Request: GET /api/paymentSolution/transactions");
      ...
      List<Integer> expectedStatusCodes = Arrays.asList(200,401,422);
      ...
      switch(Integer.toString(responseObj.statusCode()).charAt(0)){
              ...
              if (contentType.contains("application/xml") || contentType.contains("text/xml")) {
                ...
                if(stringifiedStatusCode.equals("200")){					System.out.println("Description: Get Payment Solution");
				}
