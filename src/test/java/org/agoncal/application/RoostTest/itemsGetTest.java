...
public class itemsGetTest {
    ...
    // Updated from @Before to @BeforeEach to match JUnit 5 annotations
    @BeforeEach
    public void setUp() {
      TestdataLoader dataloader = new TestdataLoader();
      envList = dataloader.loadData("src/test/java/org/agoncal/application/RoostTest/itemsGetTest.csv");
    }
